...
def _load_run_defaults(config: Optional[object]) -> dict:
    ...
    return {
        "topics": _get_run_value("topics", []),
        "topics_file": _get_run_value("topics_file", None),
        "parallelism": _get_run_value("parallelism", None),
        "output_root": _get_run_value("output_root", str(DEFAULT_OUTPUT_ROOT)),
        "console_logs": _get_run_value("console_logs", False),
        "rag_config": _get_run_value("rag_config", "src/agents/survey_agent/config/outcomeRAG.yaml"),
    }
